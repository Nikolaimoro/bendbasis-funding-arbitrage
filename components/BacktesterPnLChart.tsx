    ...
    <div className="bg-[#292e40] border border-[#343a4e] rounded-2xl p-6 mt-6">
      ...
      <div className="mb-6">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 auto-rows-fr gap-3">
            <StatCard
              icon={TrendingUp}
              ...
              className="row-span-1 sm:row-span-1 lg:row-span-2 col-span-2 sm:col-span-1 lg:col-span-2 order-1 sm:order-none"
            />
