    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute z-50 mt-2 bg-[#292e40] border border-[#343a4e] rounded-lg w-64 p-3 shadow-lg space-y-3 animate-tooltip-zoom max-h-[70vh] overflow-y-auto">
            <div>
